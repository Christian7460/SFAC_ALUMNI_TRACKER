          ...
          <div class="card px-4 pb-4">
            ...
            <div class="table-responsive">
              <table class="table table-flush" id="datatable-search">
                ...
                <tbody>
                  <?php
$liststudent = mysqli_query($db, "SELECT *, CONCAT(tbl_student.firstname, ' ', tbl_student.lastname) AS fullname FROM tbl_student
                  ");
    ...
    ?>
        ...
        echo ' <img class=" border-radius-lg shadow-sm zoom" style="height:80px; width:80px;" src="data:image/jpeg;base64,' . base64_encode($row['img']) . '" "/>';
                      ...
                      <td class="text-sm font-weight-normal">
                        <a class="btn btn-link text-danger text-gradient px-3 mb-0" href="javascript:;" data-bs-toggle="modal" data-bs-target="#deleteStudent<?php echo $id; ?>"><i class="material-icons text-sm me-2"  >delete</i>Delete</a>
                      </td>
                      <?php }?>
                    </tr>
                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            ...
                            <a href="userData/ctrl-del-student.php?student_id=<?php echo $id; ?>"><button type="button" class="btn bg-gradient-danger">Delete</button></a>
                          </div>
                        </div>
                      </div>
                    </div>
